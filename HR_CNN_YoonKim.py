...
class HR_CNN_YoonKim:
	...
	def __init__(self,
		...
		self.embeddings = tf.Variable(tf.random_normal(shape=(vocabulary_size, embedding_dim)))
		#self.embeddings=tf.get_variable("embeddings", shape=(vocabulary_size, embedding_dim), dtype=tf.float32, initializer=tf.contrib.layers.xavier_initializer())
