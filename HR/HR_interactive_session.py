...
with tf.Session() as sess:
	...
	neural_network = HR_data.load_model(sess, model=model, model_name=FLAGS.MODEL_NAME)
	...
	class_dict=HR_data.get_dataset_classes(dataset)
	...
	while True:
		...
		word_indices = HR_data.index_and_align(HR_data.process_sentence(sentence, max_sentence_length), max_sentence_length)
